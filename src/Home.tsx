      ...
      <section id="works" className="s-works target-section">
        <div className="row">
          <div className="column xl-12">
            ...
            <p className="attention-getter">
              Aşağıda, en son tamamladığım projelerden bazılarını görebilirsiniz. Her bir proje, modern web teknolojileri kullanılarak geliştirilmiş ve kullanıcı deneyimini ön planda tutan tasarım prensipleriyle oluşturulmuştur.
            </p>
          </div>
        </div>
            ...
            <div className="folio-entry__content">
              ...
              <a href={`${process.env.PUBLIC_URL}/images/folio/gallery/g-lamp.jpg`} className="folio-entry__link glightbox">
                <div className="folio-entry__text">
                  <div className="folio-entry__cat">Branding</div>
                  <div className="folio-entry__title">The Lamp</div>
                </div>
            ...
            <div className="folio-entry__content">
              ...
              <a href={`${process.env.PUBLIC_URL}/images/folio/gallery/g-tulips.jpg`} className="folio-entry__link glightbox">
                <div className="folio-entry__text">
                  ...
                  <div className="folio-entry__title">The Tulip</div>
                </div>
            ...
            <div className="folio-entry__content">
              ...
              <a href={`${process.env.PUBLIC_URL}/images/folio/gallery/g-tropical.jpg`} className="folio-entry__link glightbox">
                <div className="folio-entry__text">
                  ...
                  <div className="folio-entry__title">Tropical</div>
                </div>
          ...
          <div className="column xl-6 lg-6 md-6 folio-entry">
            <div className="folio-entry__content">
              ...
              <a href={`${process.env.PUBLIC_URL}/images/folio/gallery/g-woodcraft.jpg`} className="folio-entry__link glightbox">
                <div className="folio-entry__text">
                  <div className="folio-entry__cat">Web Design</div>
                  <div className="folio-entry__title">Woodcraft</div>
                </div>
        ...
        <div className="row s-footer__content">
          <div className="column xl-6 md-12 s-footer__block s-footer__about">                    
            <p className="attention-getter">
              ...
              fugiat laboriosam possimus amet consectetur adipisicing elit reprehenderit eveniet tempore quisquam ipsa id esse.
            </p>               
          </div>
